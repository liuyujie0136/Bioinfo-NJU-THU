### Evolutionary tree and distance matrix of sequences
## More info: https://mp.weixin.qq.com/s/Vb9MBt419sO69UOPfEb0UQ
...
## read tree data
hpv58.tree <- "tree&distance-tree.newick"
...
## Optional: add labels for monophyletic (A, C and D) and paraphyletic (B) groups  
...
## Optional: display support values
...
## read sequences from GenBank directly into R and convert the object to DNAStringSet
...
## OR: use alignment result instead of getting files from NCBI
hpv58.aln <- "tree&distance-aln.fas"
tipseq_aln <- readDNAStringSet(hpv58.aln)
...
## visualize the sequence differences using dot plot and line plot and align the sequence difference plot to the tree using facet_plot
...
ggsave("tree&distance-plot.pdf", p2, width = 20, height = 15)
